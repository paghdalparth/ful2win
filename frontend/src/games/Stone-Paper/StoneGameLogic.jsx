...
export default function RockPaperScissors() {
  ...
  useEffect(() => {
    const initializeGame = async () => {
      ...
      try {
        ...
        const response = await axios.get(`https://ful2win-backend.onrender.com/api/tictactoe/room/${roomId}/api/game/room/${roomId}`)
        if (response.data) {
        ...
        const createResponse = await axios.post('https://ful2win-backend.onrender.com/api/tictactoe/room/${roomId}/api/game/create', gameData)
  ...
  useEffect(() => {
    const checkCurrentTurn = async () => {
      ...
      try {
        const response = await axios.get(`https://ful2win-backend.onrender.com/api/tictactoe/room/${roomId}/api/game/current-turn/${gameId}`);
...
useEffect(() => {
  ...
  const handleChoice = async (choice) => {
    ...
    try {
      ...
      // Send move update
      const response = await axios.put(`https://ful2win-backend.onrender.com/api/tictactoe/room/${roomId}/api/game/move/${gameId}`, {
        playerId: userId,
        move: choice,
      ...
      const updatedGame = await axios.get(`https://ful2win-backend.onrender.com/api/tictactoe/room/${roomId}/api/game/room/${roomId}`);
  ...
  const evaluateRound = async (p1Choice, p2Choice) => {
    ...
    try {
      ...
      const currentGame = await axios.get(`https://ful2win-backend.onrender.com/api/tictactoe/room/${roomId}/api/game/room/${roomId}`)
      ...
      await axios.put(`https://ful2win-backend.onrender.com/api/tictactoe/room/${roomId}/api/game/round/${gameId}`, {
        round: updatedRound
      })
...
// Example usage:
        ...
        // Update room status
        await axios.put(`https://ful2win-backend.onrender.com/api/tictactoe/room/${roomId}/api/room/${roomId}/status`, {
          status: 'finished',
          winner: gameWinner
        })
      } else {
...
async function updateGameWinner(roomId) {
  try {
    const response = await fetch(`https://ful2win-backend.onrender.com/api/tictactoe/room/${roomId}/api/game/update-winner/${roomId}`, {
      method: 'PUT'
    });
